...
)
{
    ...
    switch (followMode)
    {
        ...
        case FOLLOW_MOVE:
            ...
            {
                DEBUG("<%d> %s: oiFollowA: Move mode%c\n",' ');
            }
            ...
            */
            ...
            if (status == CALC_SUCCESS)
            {
                DEBUG("<%d> %s: oiFollowA: Move to new target %c\n",' ');
        ...
        case FOLLOW_MOVE_R:
                     ...
                     IN_TOLERANCE                         )
            {
                ...
                if (OUT_IN_POSITION == FALSE)  
                    DEBUG("<%d> %s: oiFollowA: Moved to within tolerance of target%c\n",' ');
            }
        ...
        case FOLLOW_FOLLOW:
            ...
            {
                DEBUG("<%d> %s: oiFollowA: Follow mode%c\n",' ');
            }
		...
		stream_count = FOLLOW_RESUME;
                       ...
                       newTrack == TRUE                                        )
            {
                     ...
                     newTrack     == TRUE               )
                {
                    ...
                    {
                        newTrack = FALSE;
                        DEBUG("<%d> %s: oiFollowA: Slewing to new trackID target%c\n", ' ');
                    }

                    else if (stream_count == FOLLOW_RESUME)
                    {
                        DEBUG("<%d> %s: oiFollowA: Slewing to previous trackID target%c\n", ' ');
                    }                    

                    else
                    {
                        DEBUG("<%d> %s: oiFollowA: Recentering on new target%c\n", ' ');
                    }
            ...
            else 
            {
                ...
                {
                    DEBUG("<%d> %s: oiFollowA: Following within tolerance%c\n",' ');
                    OUT_NEW_TRACK = FALSE;
                }
            }
        ...
        case FOLLOW_STOP:
            ...
            {
                DEBUG("<%d> %s: oiFollowA: Stop following/moving%c\n",' ');
            }
        ...
        default:
            ...
            {
                DEBUG("<%d> %s: oiFollowA: ERROR ... invalid follow mode, stop following/moving%c\n",' ');
            }

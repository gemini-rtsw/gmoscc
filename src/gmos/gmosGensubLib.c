 ...
 * and make that state the output. Any states outside the range menuCarstatesIDLE to menuCarstatesERROR are ignored.
 */
 ...
 * output. Any states outside the range menuCarstatesIDLE to menuCarstatesERROR are ignored.
 */
        ...
        for ( i=0; i < MAX_CAR_RECORDS; i++)
        {
            if ( (curStates[i] <= menuCarstatesERROR) && (curStates[i] > outVal) )
            {
                outVal = curStates[i];
                outIndex = i;
            }
 ...
 */
       ...
       if ( (pgensub->b != NULL) && (*(long *)pgensub->b == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else if ( (pgensub->d != NULL) && (*(long *)pgensub->d == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else if( (pgensub->f != NULL) && (*(long *)pgensub->f == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else if( (pgensub->h != NULL) && (*(long *)pgensub->h == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else if( (pgensub->j != NULL) && (*(long *)pgensub->j == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else if( (pgensub->l != NULL) && (*(long *)pgensub->l == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else if( (pgensub->n != NULL) && (*(long *)pgensub->n == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else if( (pgensub->p != NULL) && (*(long *)pgensub->p == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else if( (pgensub->r != NULL) && (*(long *)pgensub->r == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else if( (pgensub->t != NULL) && (*(long *)pgensub->t == menuCarstatesERROR) )
       {
           outState1 = DAR_STATE_ERROR;
       }
       else
...
long gmosIlockCombine( struct genSubRecord *pgensub ) 
{
         ...
         (softIlock != 0) )
    {
        ...
        sprintf( message, "Interlock:%.4s%.4s%.4s%.4s%.4s%.4s Status:%#lx",
            (!gisEvent       ? " Evt" : " "),
            (!gisEventError  ? "+Err" : " "),
            (!gisDemand      ? " Dmd" : " "),
            (!gisDemandError ? "+Err" : " "),
 ...
 */
    ...
    callbackSetCallback((CALLBACKFUNC)tempchangeCallback, &pcallback->callback );

...
w 2088 1291 100 0 n#84 egenSubD.dtaTrack.OUTH 1984 1280 2240 1280 2240 976 2400 976 eaos.tempYoff.SLNK
w 2104 1355 100 0 n#83 egenSubD.dtaTrack.OUTG 1984 1344 2272 1344 2272 1296 2400 1296 eaos.tempXoff.SLNK
w 2104 1419 100 0 n#82 egenSubD.dtaTrack.OUTF 1984 1408 2272 1408 2272 1584 2400 1584 eaos.flexZoff.SLNK
w 2088 1483 100 0 n#81 egenSubD.dtaTrack.OUTE 1984 1472 2240 1472 2240 1872 2400 1872 eaos.flexYoff.SLNK
w 2072 1547 100 0 n#80 egenSubD.dtaTrack.OUTD 1984 1536 2208 1536 2208 2128 2400 2128 eaos.flexXoff.SLNK
...
s 1584 2144 100 0 within this gensub relies
s 1584 2192 100 0 NOTE: the function gmSeqDtaDemands
s 2432 2336 100 0 $Id$
s 2704 128 200 0 GMOS Sequencer
s 2432 32 100 0 Chris Mayer
s 2704 80 100 0 Flexure Model Parameters
...
xform 0 448 2208
p 355 2200 100 0 -1 val(in):$(gm)cc:temp8
...
use hwin 128 439 100 0 hwin#91
xform 0 224 480
p 131 472 100 0 -1 val(in):$(cc)dtaAssembly.AAHL
use hwin 128 375 100 0 hwin#92
xform 0 224 416
p 131 408 100 0 -1 val(in):$(cc)dtaAssembly.ABLL
use hwin 128 311 100 0 hwin#93
xform 0 224 352
p 131 344 100 0 -1 val(in):$(cc)dtaAssembly.ABHL
use hwin 128 247 100 0 hwin#94
xform 0 224 288
p 131 280 100 0 -1 val(in):$(cc)dtaAssembly.ACLL
...
xform 0 2528 2128
p 2144 1598 100 0 0 ADEL:0.0
p 2400 2224 100 0 -1 DESC:X flexure contribution
p 2688 2016 100 0 1 EGU:microns
p 2480 2016 100 0 1 OMSL:supervisory
p 2688 1984 100 0 1 PREC:2
use eaos 2400 1783 100 0 flexYoff
xform 0 2528 1872
p 2144 1342 100 0 0 ADEL:0.0
p 2400 1968 100 0 -1 DESC:Y flexure contribution
p 2688 1744 100 0 1 EGU:microns
p 2464 1744 100 0 1 OMSL:supervisory
p 2688 1712 100 0 1 PREC:2
use eaos 2400 1495 100 0 flexZoff
xform 0 2528 1584
p 2144 1054 100 0 0 ADEL:0.0
p 2400 1680 100 0 -1 DESC:Z flexure contribution
p 2704 1456 100 0 1 EGU:microns
p 2464 1456 100 0 1 OMSL:supervisory
p 2704 1424 100 0 1 PREC:2
use eaos 2400 1207 100 0 tempXoff
xform 0 2528 1296
p 2144 766 100 0 0 ADEL:0.0
p 2400 1392 100 0 -1 DESC:X temperature contribution
p 2704 1168 100 0 1 EGU:microns
p 2480 1168 100 0 1 OMSL:supervisory
p 2704 1136 100 0 1 PREC:2
use eaos 2400 887 100 0 tempYoff
xform 0 2528 976
p 2144 446 100 0 0 ADEL:0.0
p 2400 1072 100 0 -1 DESC:Y temperature contribution
p 2704 848 100 0 1 EGU:microns
p 2480 848 100 0 1 OMSL:supervisory
p 2704 816 100 0 1 PREC:2
use eaos 2400 599 100 0 tempZoff
xform 0 2528 688
p 2144 158 100 0 0 ADEL:0.0
p 2400 784 100 0 -1 DESC:Z temperature contribution
p 2688 576 100 0 1 EGU:microns
p 2464 576 100 0 1 OMSL:supervisory
p 2688 544 100 0 1 PREC:2
use eaos 2400 327 100 0 totalFocusOffset
xform 0 2528 416
p 2144 -114 100 0 0 ADEL:0.0
p 2400 512 100 0 -1 DESC:Total focus offset
p 2704 288 100 0 1 EGU:microns
p 2464 288 100 0 1 OMSL:supervisory
p 2704 256 100 0 1 PREC:2
use eais 64 1975 100 0 refTemp
xform 0 192 2048
p -32 2128 100 0 -1 DESC:Reference temperature for thermal model
p 256 1968 100 0 1 EGU:deg C
p -192 1854 100 0 0 EGUF:25.0
p -192 1822 100 0 0 EGUL:-25.0
p -192 1758 100 0 0 HOPR:25.0
p -192 1726 100 0 0 LOPR:-25.0
p 256 1936 100 0 1 PREC:2
use outhier 2144 1719 100 0 XPOS
xform 0 2160 1760
use outhier 2144 1655 100 0 YPOS
xform 0 2160 1696
use outhier 2144 1591 100 0 ZPOS
xform 0 2160 1632
use outhier 2048 983 100 0 FLNK
xform 0 2064 1024
use egenSubD 1696 967 100 0 dtaTrack
xform 0 1840 1392
p 1632 1824 100 0 -1 DESC:Compute detector translation demands
p 1776 1760 100 0 1 FTA:DOUBLE
p 1776 1728 100 0 1 FTB:DOUBLE
p 1776 1696 100 0 1 FTC:LONG
p 1776 1664 100 0 1 FTD:LONG
p 1776 1632 100 0 1 FTE:DOUBLE
p 1776 1600 100 0 1 FTF:DOUBLE
p 1776 1568 100 0 1 FTG:DOUBLE
p 1776 1536 100 0 1 FTH:DOUBLE
p 1776 1504 100 0 1 FTI:DOUBLE
p 1776 1472 100 0 1 FTJ:DOUBLE
p 1776 1440 100 0 1 FTK:LONG
p 1776 1408 100 0 1 FTL:DOUBLE
p 1776 1376 100 0 1 FTM:DOUBLE
p 1776 1344 100 0 1 FTN:DOUBLE
p 1776 1312 100 0 1 FTO:DOUBLE
p 1776 1280 100 0 1 FTP:DOUBLE
p 1776 1248 100 0 1 FTQ:DOUBLE
p 1776 1216 100 0 1 FTR:DOUBLE
p 1776 1184 100 0 1 FTS:DOUBLE
p 1776 1152 100 0 1 FTT:DOUBLE
p 1776 1120 100 0 1 FTU:DOUBLE
p 2064 1776 100 0 -1 FTVA:DOUBLE
p 2064 1712 100 0 -1 FTVB:DOUBLE
p 2064 1648 100 0 -1 FTVC:DOUBLE
p 2064 1552 100 0 -1 FTVD:DOUBLE
p 2064 1488 100 0 -1 FTVE:DOUBLE
p 2064 1424 100 0 -1 FTVF:DOUBLE
p 2064 1360 100 0 -1 FTVG:DOUBLE
p 2064 1296 100 0 -1 FTVH:DOUBLE
p 2064 1232 100 0 -1 FTVI:DOUBLE
p 2064 1168 100 0 -1 FTVJ:DOUBLE
...
p 1984 1354 75 0 -1 pproc(OUTG):PP
p 1984 1290 75 0 -1 pproc(OUTH):PP
p 1984 1226 75 0 -1 pproc(OUTI):PP
p 1984 1162 75 0 -1 pproc(OUTJ):PP

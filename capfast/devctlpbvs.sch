...
[tools]
[detail]
w -248 363 100 0 dbug inhier.dbug.P -736 352 288 352 288 416 576 416 edevctlm.Device.DBUG
...
s 432 -160 100 0 on this Capfast schematic.
s 432 -128 100 0 all its properties defined correctly
s 432 -96 100 0 above record does not necessarily have
s 432 -64 100 0 are initialised using pvload, so the
s 432 -32 100 0 NOTE: all the device record properties
[cell use]
...
p 640 224 100 0 1 TDIR:/home/smb/gmos/lut
...
p 1820 -576 120 256 -1 Title:GMOS Device With Brake (VALS)

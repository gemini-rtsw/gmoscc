...
w 216 1859 100 0 n#96 gmosCcSystem.gmosCcSystem#116.OERR 64 1856 416 1856 416 2112 736 2112 egenSubD.applyCGensub.INPC
w 536 2147 100 0 n#95 gmosCcSystem.gmosCcSystem#116.OMSS 64 1888 384 1888 384 2144 736 2144 egenSubD.applyCGensub.INPB
w 520 2179 100 0 n#94 gmosCcSystem.gmosCcSystem#116.CAR 64 1920 352 1920 352 2176 736 2176 egenSubD.applyCGensub.INPA
...
p 1072 672 100 0 1 setb:sadtop $(sadtop)
...
p 384 672 100 0 1 setb:c1 $(c1)
p 384 640 100 0 1 setc:c2 $(c2)
p 384 608 100 0 1 setd:cc $(cc)
p 384 576 100 0 1 sete:xycom $(bothXycom)
p 384 544 100 0 1 setf:iointr $(bothIointr)
use tempSensors 40 719 100 0 tempSensors#123
xform 0 128 832
p 32 704 100 0 1 seta:top $(top)$(cc)
p 32 640 100 0 1 setc:xycom $(bothXycom)
p 32 608 100 0 1 setd:iointr $(bothIointr)
use doors -312 711 100 0 doors#122
xform 0 -224 832
p -320 704 100 0 1 seta:top $(top)$(cc)
p -320 672 100 0 1 setb:xycom $(bothXycom)
p -320 640 100 0 1 setc:iointr $(bothIointr)
use xycomOut -672 711 100 0 xycomOut#121
xform 0 -576 832
p -672 704 100 0 1 seta:top $(top)
p -672 672 100 0 1 setb:c1 $(c1)
p -672 640 100 0 1 setc:c2 $(c2)
p -672 608 100 0 1 setd:cc $(cc)
p -672 576 100 0 1 sete:xycom $(bothXycom)
p -672 544 100 0 1 setf:iointr $(bothIointr)
use xycomIn -1024 695 100 0 xycomIn#119
xform 0 -928 824
p -1024 704 100 0 1 seta:top $(top)
p -1024 672 100 0 1 setb:c1 $(c1)
p -1024 640 100 0 1 setc:c2 $(c2)
p -1024 608 100 0 1 setd:cc $(cc)
p -1024 576 100 0 1 sete:xycom $(bothXycom)
...
xform 0 1600 2064
p 1504 2240 100 0 1 PV:$(top)$(cc)
use egenSubD 944 2240 100 0 applyCGensub
xform 0 880 1808
p 816 2176 100 0 1 FTA:LONG
p 816 2144 100 0 1 FTB:STRING
p 816 2112 100 0 1 FTC:LONG
p 816 2080 100 0 1 FTD:LONG
p 816 2048 100 0 1 FTE:STRING
p 816 2016 100 0 1 FTF:LONG
p 816 1984 100 0 1 FTG:LONG
p 816 1952 100 0 1 FTH:STRING
p 816 1920 100 0 1 FTI:LONG
p 513 901 100 0 0 FTJ:LONG
p 513 1157 100 0 0 FTK:STRING
p 513 1157 100 0 0 FTL:LONG
p 513 1125 100 0 0 FTM:LONG
p 513 1093 100 0 0 FTN:STRING
p 513 1061 100 0 0 FTO:LONG
p 513 997 100 0 0 FTP:LONG
p 513 997 100 0 0 FTQ:STRING
p 513 965 100 0 0 FTR:LONG
p 513 933 100 0 0 FTS:LONG
p 513 901 100 0 0 FTT:STRING
p 513 901 100 0 0 FTU:LONG
p 1120 2160 100 0 1 FTVA:LONG
p 1120 2096 100 0 1 FTVB:STRING
p 1120 2032 100 0 1 FTVC:LONG
p 1120 1968 100 0 1 FTVD:LONG
p 752 2240 100 0 1 PV:$(top)$(cc)
p 816 1344 100 0 1 SCAN:Passive
p 816 1312 100 0 1 SNAM:gmosCarCombineBusy

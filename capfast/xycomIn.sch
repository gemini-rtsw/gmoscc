...
s 3776 256 100 0 XYCOM driver bug means interrupts are sometimes missed.
s 3776 192 100 0 with ".1 second" to overcome this problem.
s 3776 224 100 0 If these spare records are used replace "$(iointr)" scan
[cell use]
use ebis 4160 592 100 0 bp1b7
xform 0 4096 528
p 3795 603 100 0 0 DESC:TTL switch input bp1b7
...
xform 0 4096 848
p 3795 923 100 0 0 DESC:TTL switch input bp0b7

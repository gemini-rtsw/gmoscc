...
[tools]
[detail]
w 1032 971 100 0 n#66 elongouts.Busy.DOL 1056 960 1056 960 hwin.hwin#22.in
w 1060 1195 100 2 n#64 hwin.hwin#63.in 1056 1200 1056 1200 elongouts.dcMark.DOL
w 808 1179 100 0 n#62 ecad2.ecad2#8.PLNK 160 256 256 256 256 608 608 608 608 1168 1056 1168 elongouts.dcMark.SLNK
...
s 464 1456 150 0 Generic CAD/CAR for trivial sequence command
s 880 1008 100 0 BUSY
s 832 480 100 0 IDLE
s 576 1552 180 0 Sequence Command Type D
s 2112 1632 150 0 gmSeqcadcarD
s 464 1376 160 0 MARKs in Detector Controller only
[cell use]
use elongouts 1056 1079 100 0 dcMark
xform 0 1184 1168
p 896 1310 100 0 0 EGU:CAD directive
p 1104 1264 100 0 1 OMSL:closed_loop
p 1392 1136 100 0 -1 def(OUT):$(dc)$(seqcommand).DIR
p 1264 1280 100 1024 1 name:$(gm)$(seqcommand)$(I)
...
use hwin 864 1159 100 0 hwin#63
xform 0 960 1200
p 867 1192 100 0 -1 val(in):$(CAD_MARK)
...
xform 0 864 496
p 2124 -560 120 256 -1 Title:GMOS IS - trivial sequence command (type D)
use efanouts 344 88 100 0 fan
xform 0 440 240
p 352 352 100 0 1 SELM:All
p 496 48 100 1024 1 name:$(gm)$(seqcommand)$(I)
...
p -128 366 100 0 -1 SNAM:gmSeqCadTrivial
p -256 510 100 0 0 def(INPA):0.0
p 240 494 100 0 0 def(OUTA):0.0
p -144 78 100 0 1 name:$(gm)$(seqcommand)

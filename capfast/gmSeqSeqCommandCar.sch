...
w 1856 2267 100 0 n#19 ecalcouts.MonChange.VAL 640 2144 1088 2144 1088 2256 2672 2256 2672 1728 3024 1728 egenSubD.egenSubD#18.INPA
...
p 408 2256 100 0 1 SCAN:Passive
p 736 2400 60 0 0 def(INPA):$(cc)$(seqcommand)C.VAL
p 384 2024 100 0 -1 name:$(gm)$(seqcommand)CcWaitCar
p 272 2216 75 0 -1 pproc(INPA):CPP
...
p 392 1472 100 0 1 SCAN:Passive
p 720 1616 60 0 0 def(FLNK):0.000000000000000e+00
p 720 1616 60 0 0 def(INPA):$(dc)$(seqcommand)C.VAL 
p 368 1240 100 0 -1 name:$(gm)$(seqcommand)DcWaitCar
p 256 1432 75 0 -1 pproc(INPA):CPP

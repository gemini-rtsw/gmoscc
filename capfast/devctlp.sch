...
[tools]
[detail]
w -200 267 100 0 dbug inhier.dbug.P -736 256 384 256 384 416 576 416 edevctlm.Device.DBUG
w -216 363 100 0 simm inhier.simm.P -736 352 352 352 352 480 576 480 edevctlm.Device.SIMM
...
xform 0 560 480
p 2132 -696 100 512 1 File:/data/nimpkish/1/daoinsw/dev/gmos/current/develop/gmDeviceControl/capfast/devctlp.sch
p 1540 -652 150 0 1 Rev:A
p 1820 -576 120 256 -1 Title:GMOS Device Without Brake

...
[tools]
[detail]
w -248 331 100 0 dbug inhier.dbug.P -736 320 288 320 288 416 576 416 edevctlm.Device.DBUG
...
xform 0 -736 480
use inhier -768 336 100 512 dbug
xform 0 -736 320
...
xform 0 560 480
p 2132 -696 100 512 1 File:/data/nimpkish/1/daoinsw/dev/gmos/current/develop/gmDeviceControl/capfast/devctlpv.sch
p 1540 -652 150 0 1 Rev:A
p 1820 -576 120 256 -1 Title:GMOS Device Without Brake (VAL)

...
[tools]
[detail]
w 840 -245 100 0 n#66 efanouts.fan.LNK4 560 208 672 208 672 -256 1056 -256 elongouts.ObsClr.SLNK
w 968 -213 100 0 n#63 hwin.hwin#64.in 992 -224 1056 -224 elongouts.ObsClr.DOL
...
s 1056 -112 100 0 to work around channel access feature.
s 1056 -80 100 0 Send a CLEAR directive to the observe CAD record
s 816 -176 100 0 CLEAR
...
[cell use]
use elongouts 1056 -345 100 0 ObsClr
xform 0 1184 -256
p 941 89 100 0 0 DESC:Writes BUSY to CAR record
p 896 -114 100 0 0 EGU:CAR value
p 1120 -368 100 0 1 OMSL:closed_loop
p 1376 -320 100 0 -1 def(OUT):$(gm)dc:observe.DIR
p 1216 -176 100 1024 1 name:$(gm)$(seqcommand)$(I)
p 1312 -288 75 768 -1 pproc(OUT):PP
use hwin 824 -264 100 0 hwin#64
xform 0 896 -224
p 803 -232 100 0 -1 val(in):$(CAD_CLEAR)
